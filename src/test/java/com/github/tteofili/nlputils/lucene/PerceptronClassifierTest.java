...
public class PerceptronClassifierTest {
  ...
  public void ppsIntegrationTest() throws Exception {
    ...
    Boolean isAgency = bytesRefClassificationResult.getAssignedClass().utf8ToString().equals("A");
    ...
    isAgency = bytesRefClassificationResult.getAssignedClass().utf8ToString().equals("A");
    assertTrue(isAgency);
